...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    public void Save()
    {
      ...
      var cmd = conn.CreateCommand() as MySqlCommand;
      cmd.CommandText = @"INSERT INTO `items` (`description`,`date`) VALUES (@ItemDescription, @ItemRawDate);";
      ...
      date.ParameterName = "@ItemRawDate";
    ...
    public override bool Equals(System.Object otherItem)
    {
      ...
      else
      {
        ...
        bool Equality = (this.GetId() == newItem.GetId());
        return (idEquality && descriptionEquality && Equality);
      }
    }
